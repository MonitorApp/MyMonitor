...
public class CombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
    ...
    public enum DrawOrder {
        BAR, HORIZONTAL_BAR, BUBBLE, LINE, CANDLE, SCATTER
    }
    ...
    protected void init() {
        ...
        mDrawOrder = new DrawOrder[]{
                DrawOrder.BAR, DrawOrder.HORIZONTAL_BAR, DrawOrder.BUBBLE, DrawOrder.LINE, DrawOrder.CANDLE, DrawOrder.SCATTER
        };
    ...
    public HorizontalBarData getHorizontalBarData() {
        if (mData == null)
            return null;
        return mData.getHorizontalBarData();
    }
