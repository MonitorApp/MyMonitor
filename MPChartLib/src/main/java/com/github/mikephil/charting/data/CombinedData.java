...
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends Entry>> {
    ...
    private HorizontalBarData mHorizontalBarData;
    ...
    public void setData(HorizontalBarData data) {
        mHorizontalBarData = data;
        notifyDataChanged();
    }
    ...
    public HorizontalBarData getHorizontalBarData() {
        return mHorizontalBarData;
    }
    ...
    public List<BarLineScatterCandleBubbleData> getAllData() {
        ...
        if (mBarData != null)
            data.add(mBarData);
        if (mHorizontalBarData != null)
            data.add(mHorizontalBarData);
    ...
    public void notifyDataChanged() {
        ...
        if (mHorizontalBarData != null)
            mHorizontalBarData.notifyDataChanged();
        if (mCandleData != null)
