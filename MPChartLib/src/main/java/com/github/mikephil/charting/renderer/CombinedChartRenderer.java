...
public class CombinedChartRenderer extends DataRenderer {
        ...
        for (DrawOrder order : orders) {
            ...
            switch (order) {
                case BAR:
                    ...
                    break;
                case HORIZONTAL_BAR:
                    if (chart.getHorizontalBarData() != null)
                        mRenderers.add(new HorizontalBarChartRenderer(chart, mAnimator, mViewPortHandler));
                    break;
                case BUBBLE:
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (DataRenderer renderer : mRenderers) {
            ...
            if (renderer instanceof HorizontalBarChartRenderer)
                data = ((HorizontalBarChartRenderer) renderer).mChart.getHorizontalBarData();
            else if (renderer instanceof BarChartRenderer)
