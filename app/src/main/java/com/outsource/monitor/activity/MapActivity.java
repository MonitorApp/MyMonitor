...
import com.outsource.monitor.App;
import com.outsource.monitor.R;
import com.outsource.monitor.base.BaseActivity;
import com.outsource.monitor.map.LocationManager;
import com.outsource.monitor.map.MyPoi;
...
/**
 * Created by xionghao on 2017/1/1.
 */
...
public class MapActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationService = LocationManager.getInstance(this).getLocationService();
        startLocation();
    ...
    private void refreshMarkOverlays() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int drawableId = R.drawable.ic_map_midway;
            if (i == 0) {
                drawableId = R.drawable.ic_map_departure;
            } else if (i == size - 1) {
                drawableId = R.drawable.ic_map_terminal;
            }
...
//                overlay.zoomToSpan();
    ...
    private void moveToCenterPoint(MyPoi centerPoi) {
        ...
        MapStatus status = new MapStatus.Builder().target(centerPoint).targetScreen(point).zoom(17).build();
    ...
    private void popupGetOnOffStationWindow(final MyPoi poi) {
        ...
        final View popupView = View.inflate(this, R.layout.map_popup, null);
