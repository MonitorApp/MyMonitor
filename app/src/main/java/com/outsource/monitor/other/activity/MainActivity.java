...
import com.outsource.monitor.monitor.base.ui.MonitorCenterActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.tv_band_scan:
                intent.putExtra(MonitorCenterActivity.TAB, Tab.FSCAN);
                startActivity(intent);
                break;
            case R.id.tv_df:
            ...
            case R.id.tv_discrete_scan:
                intent.putExtra(MonitorCenterActivity.TAB, Tab.DISCRETE);
                startActivity(intent);
                break;
            case R.id.tv_digit_scan:
                intent.putExtra(MonitorCenterActivity.TAB, Tab.DIGIT);
                startActivity(intent);
                break;
            case R.id.tv_map:
